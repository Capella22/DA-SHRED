...
if __name__ == "__main__":
    ...
    fig_valid.suptitle(
             f'Reconstruction Comparison (VALIDATION)',
             fontsize=20, y=1.02)
    ...
    plt.suptitle(f'Multiscale DA-SHRED on RDE Data (VALIDATION)\n'
                  f'LF RMSE: {rmse_lf_valid:.4f} → LF+HF RMSE: {rmse_total_valid:.4f} '
                  f'({(rmse_lf_valid - rmse_total_valid) / rmse_lf_valid * 100:.1f}% improvement)', fontsize=18)

    plt.tight_layout()
    plt.savefig('Multiscale_RDE_results_validation.png', dpi=150, bbox_inches='tight')
    print("    Saved: Multiscale_RDE_results_validation.png")
    ...
    fig_4panel.suptitle(
        f'Reconstruction Comparison', fontsize=20, y=1.02)
    ...
    plt.suptitle(f'Multiscale DA-SHRED on RDE Data\n'
    ...
    plt.tight_layout()
    plt.savefig('Multiscale_RDE_results.png', dpi=150, bbox_inches='tight')
    print("    Saved: Multiscale_RDE_results.png")
